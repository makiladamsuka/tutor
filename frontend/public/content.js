...
(() => {
  ...
  var blockIdToNode = /* @__PURE__ */ new Map();
  var usedNodes = /* @__PURE__ */ new WeakSet();
  function normalizeText(text) {
    return text.replace(/\s+/g, " ").trim();
  }
  function walkBlockElements(root, onBlock) {
  ...
  function runExtraction() {
    ...
    const parsed = new import_readability.Readability(document.cloneNode(true)).parse();
    if (!parsed) {
